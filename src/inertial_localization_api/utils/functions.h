...
std::vector<T_arrange> Arange(T_arrange start, T_arrange stop,
                              T_arrange step = 1) {
...
/**
 * @brief Creates a linearly spaced vector of specified size between start and
 * end values.
 *
 * @param start First value in the sequence
...
/**
/**
 * @brief Creates a sequence of evenly spaced double values (convenience
overload).
 *
 * @param start First value in the sequence
 * @param stop Value to stop before (exclusive)
...
/**
 * @brief Creates a 2D affine transformation matrix from position and
 * orientation.
 *
 * @param x X position
 * @param y Y position
