...
def main():
    ...
    for i, reading in tqdm(enumerate(trip_obj.sorted_localization_inputs), total=len(trip_obj.sorted_localization_inputs), desc="Processing sensors"):
        ...
        if timestamp >= carpose_t0: 
            ...
            position = loc_handler.GetPosition()  # Use correct method name from ahrs_loc_handler.h
            yaw = loc_handler.GetVehicleHeading()  # Use correct method name from ahrs_loc_handler.h
